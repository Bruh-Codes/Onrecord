...
import { ChevronRightIcon, CounterpartiesIcon, UploadIcon } from "@/components/icons";

export function GetStartedCard() {
  return (
    <div className="bg-panel rounded-3xl p-8 mb-7.5">
      <h2 className="text-2xl m-0 mb-1.5">Get started with Sankofa</h2>
      ...
      <div className="flex gap-5 flex-wrap">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[14.5px] font-semibold mb-0.5">Upload the missing MoMo window</div>
            <div className="text-xs opacity-60">3 Feb – 3 May · closes your biggest coverage gap</div>
          </div>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[14.5px] font-semibold mb-0.5">Classify Adom Ventures</div>
            <div className="text-xs opacity-60">Clears 34 unclassified transactions at once</div>
          </div>
          <ChevronRightIcon className="opacity-40 shrink-0" />
        </Link>
      </div>
