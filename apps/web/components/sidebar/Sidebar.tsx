...
export function Sidebar() {
  return (
    <div className="w-[230px] shrink-0 bg-panel px-3.5 py-5 flex flex-col border-r border-border">
      <Link href="/" className="flex items-center gap-2 px-2 pb-5">
        <span className="w-[26px] h-[26px] rounded-lg bg-ink inline-block" />
        <span className="font-[family-name:var(--font-display)] text-[15px]">Sankofa</span>
      </Link>
